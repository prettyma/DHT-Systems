...
/**
 * Created by prettyphilip on 4/5/18.
 */

public class ChordDBHelper extends SQLiteOpenHelper {

    //DB-Table Details
    private static final String DB_NAME = "DS_PROJECT3_DB";
    private static final int DATABASE_VERSION = 2;
    private static final String TABLE_NAME = "CHORD_DHT";

    //Column name
    private static final String KEY = "key";
    private static final String VALUE = "value";

    public ChordDBHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
